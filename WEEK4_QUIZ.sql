...
--------------------------------------------------------------------------------------------------------------------------
--> Q2) Create a new employee user id by combining the first 4 letter of the employee’s first name with 
-- the first 2 letters of the employee’s last name. Make the new field lower case and pull each individual step to show your work.
